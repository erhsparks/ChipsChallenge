...
/***/ function(module, exports, __webpack_require__) {
	...
	var _chips_game = __webpack_require__(2);
	
	var _chips_game2 = _interopRequireDefault(_chips_game);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	(0, _jQuery2.default)(function () {
	  new _chips_game2.default();
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _info_pane = __webpack_require__(8);
	...
	var ChipsChallenge = function () {
	  function ChipsChallenge() {
	    _classCallCheck(this, ChipsChallenge);
	
	    this.gameMap = new _map2.default();
	  ...
	  _createClass(ChipsChallenge, [{
	    ...
	    key: 'listenforArrowKeys',
	    value: function listenforArrowKeys() {
	      var _this2 = this;
	
	      this.keysToListenFor = ['ArrowUp', 'ArrowDown', 'ArrowLeft', 'ArrowRight'];
	
	      d3.select('body').on('keydown', function () {
	        return _this2.handleKeypress(d3.event);
	      }).on('keyup', function () {
	        return _this2.handleWin();
	      });
	    }
	  }, {
	    key: 'handleKeypress',
	    ...
	    key: 'moveChip',
	    value: function moveChip(direction) {
	      var chip = this.gameMap.gameObjects.chipOurHero[0];
	      var x = parseInt(chip.attr('x'));
	      var y = parseInt(chip.attr('y'));
	      var dXY = this.gameMap.tileSize;
	    ...
	    key: 'chipCanMove',
	    value: function chipCanMove(x, y) {
	      return !(this.isWallAt(x, y) || this.isBarrierAt(x, y));
	    }
	  }, {
	    key: 'isWallAt',
	    value: function isWallAt(x, y) {
	      var isWall = false;
	
	      d3.selectAll('.walls').each(function () {
	        var wall = d3.select(this);
	        var wallX = parseInt(wall.attr('x'));
	        var wallY = parseInt(wall.attr('y'));
	    ...
	    value: function isBarrierAt(x, y) {
	      ...
	      barrierNames.forEach(function (barrierName) {
	        ...
	        d3.selectAll(barrierName).each(function () {
	          ...
	          var barrierY = parseInt(barrier.attr('y'));
	    ...
	    key: 'didWeWin',
	    value: function didWeWin(x, y) {
	      var portal = d3.selectAll('.winPortal');
	      var portalX = parseInt(portal.attr('x'));
	      var portalY = parseInt(portal.attr('y'));
	    ...
	    value: function checkForItems(x, y) {
	      ...
	      itemNames.forEach(function (itemName) {
	        d3.selectAll(itemName).each(function () {
	          ...
	          var itemX = parseInt(item.attr('x'));
	  ...
	  return ChipsChallenge;
	}();
	
	exports.default = ChipsChallenge;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var LevelOneMap = function () {
	  function LevelOneMap(root) {
	    _classCallCheck(this, LevelOneMap);
	  ...
	  _createClass(LevelOneMap, [{
	    key: 'makeMap',
	    value: function makeMap(root) {
	      this.gameMapContainer = d3.select('body').append('main').attr('class', 'game-map-container').attr('width', this.numCols * this.tileSize + 8).attr('height', this.numRows * this.tileSize + 8);
	
	      this.gameMap = this.gameMapContainer.append('svg').attr('class', 'game-map').attr('width', this.numCols * this.tileSize).attr('height', this.numRows * this.tileSize);
	    ...
	    value: function addGrid() {
	      ...
	      for (var y = 0; y < this.numRows; y++) {
	        for (var x = 0; x < this.numCols; x++) {
	          this.gameMap.append('rect').attr('x', x * this.tileSize).attr('y', y * this.tileSize).attr('width', this.tileSize).attr('height', this.tileSize).style('fill', 'url(#' + nameString + ')').attr('class', 'floorTile');
	        }
	      }
	    }
	  }, {
	    ...
	    value: function addTiles() {
	      ...
	      var tileStarts = this.tileStartingPositions();
	      var tiles = Object.keys(tileStarts);
	      ...
	      tiles.forEach(function (tileType) {
	        ...
	        tileStarts[tileType].forEach(function (tilePos) {
	          ...
	          _this.gameMap.append('rect').attr('x', x * _this.tileSize).attr('y', y * _this.tileSize).attr('width', _this.tileSize).attr('height', _this.tileSize).style('fill', 'url(#' + nameString + ')').attr('class', tileType);
	        });
	      });
	    }
	  }, {
	    ...
	    value: function addItems() {
	      ...
	      var mapItems = this.itemStartingPositions();
	      var items = Object.keys(mapItems);
	      ...
	      items.forEach(function (itemType) {
	        ...
	        mapItems[itemType].forEach(function (itemPos) {
	          ...
	          var item = _this2.gameMap.append('rect').attr('x', x * _this2.tileSize).attr('y', y * _this2.tileSize).attr('width', _this2.tileSize).attr('height', _this2.tileSize).style('fill', 'url(#' + nameString + ')').attr('class', itemType);
	
	          _this2.gameObjects[itemType] = [];
	          _this2.gameObjects[itemType].push(item);
	        });
	      });
	    }
	  }, {
	    key: 'itemStartingPositions',
	    value: function itemStartingPositions() {
	      return {
	        hint: [[10, 8]],
	        chipOurHero: [[10, 9]],
	        chipSocket: [[10, 6]],
	        ...
	        redDoors: [[13, 7], [7, 11]],
	        redKeys: [[12, 8], [12, 10]],
	        yellowDoors: [[9, 12], [11, 12]],
	        yellowKeys: [[5, 7], [15, 7]],
	        computerChips: [[7, 5], [13, 5], [5, 10], [15, 10], [8, 9], [12, 9], [5, 10], [15, 10], [10, 11], [9, 14], [11, 14]]
	      };
	    }
	  }, {
	    key: 'tileStartingPositions',
	    value: function tileStartingPositions() {
	      return {
	        winPortal: [[10, 5]],
	        walls: [[5, 3], [6, 3], [7, 3], [8, 3], [9, 3], [11, 3], [12, 3], [13, 3], [14, 3], [15, 3], [5, 4], [9, 4], [10, 4], [11, 4], [15, 4], [5, 5], [9, 5], [11, 5], [15, 5], [3, 6], [4, 6], [5, 6], [6, 6], [7, 6], [9, 6], [11, 6], [13, 6], [14, 6], [15, 6], [16, 6], [17, 6], [3, 7], [17, 7], [3, 8], [7, 8], [13, 8], [17, 8], [3, 9], [4, 9], [5, 9], [6, 9], [7, 9], [13, 9], [14, 9], [15, 9], [16, 9], [17, 9], [3, 10], [7, 10], [13, 10], [17, 10], [3, 11], [17, 11], [3, 12], [4, 12], [5, 12], [6, 12], [7, 12], [8, 12], [10, 12], [12, 12], [13, 12], [14, 12], [15, 12], [16, 12], [17, 12], [7, 13], [10, 13], [13, 13], [7, 14], [10, 14], [13, 14], [7, 15], [10, 15], [13, 15], [7, 16], [8, 16], [9, 16], [10, 16], [11, 16], [12, 16], [13, 16]]
	      };
	    }
	  }]);
...
/***/ function(module, exports) {
	...
	var regularFloor = exports.regularFloor = 'regular_floor';
	var walls = exports.walls = 'wall';
	var winPortal = exports.winPortal = 'win_portal';
...
/***/ function(module, exports) {
	...
	var chipOurHero = exports.chipOurHero = 'chip_down';
	var hint = exports.hint = 'hint';
	var computerChips = exports.computerChips = 'chip';
	var chipSocket = exports.chipSocket = 'chip_socket';
	
	var redDoors = exports.redDoors = 'red_door';
	var blueDoors = exports.blueDoors = 'blue_door';
	var greenDoors = exports.greenDoors = 'green_door';
	var yellowDoors = exports.yellowDoors = 'yellow_door';
	
	var redKeys = exports.redKeys = 'red_key';
	var blueKeys = exports.blueKeys = 'blue_key';
	var greenKeys = exports.greenKeys = 'green_key';
...
/***/ function(module, exports, __webpack_require__) {
	...
	var InfoPane = function () {
	  function InfoPane(timeLeft, chipsLeft, chipHasItems) {
	  ...
	  _createClass(InfoPane, [{
	    ...
	    key: 'addInfoText',
	    value: function addInfoText() {
	      this.infoPane.append('text').attr('x', 51).attr('y', 35).text('Level').attr('class', 'info-pane-text');
	
	      this.infoPane.append('text').attr('x', 60).attr('y', 112).text('Time').attr('class', 'info-pane-text');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var winBox = exports.winBox = function winBox(winTime) {
	  var message = ['Yowzer! you', 'beat the level', 'in ' + winTime + ' seconds!', ' ', 'Great work!'];
